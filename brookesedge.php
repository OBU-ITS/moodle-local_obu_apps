...
/**
 * OBU Apps - BrookesEDGE web app host page.
 *
 * @package    obu_apps
 * @category   local
...
$url = new moodle_url('/local/obu_apps/brookesedge.php');
$launch = new moodle_url('/local/obu_apps/launch.php?app=brookes_edge&service=brookes_edge_ws');
$heading = 'BrookesEDGE';
